    ...
    raw.update(
        {
            ...
            "tactile_encoder_repo_id": config.tactile_encoder_repo_id,
            "tactile_encoder_revision": config.tactile_encoder_revision,
            "tactile_encoder_sha256": config.tactile_encoder_sha256,
