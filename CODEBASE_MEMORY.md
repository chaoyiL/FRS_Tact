...
- Static gates passed: `py_compile` for all 27 changed Python files, `bash -n` for both changed shell files, `git diff --check b40a827..HEAD`, and clean-worktree `git diff --check` all exited 0.
