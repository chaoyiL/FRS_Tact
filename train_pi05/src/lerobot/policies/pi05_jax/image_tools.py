# Vendored from openpi (Apache-2.0), src/openpi/shared/image_tools.py,
# commit 15a9616a00943ada6c20a0f158e3adb39df2ccac (2026-06-16).
# Only change: `openpi.shared.array_typing` -> local `array_typing` import.
...
def resize_direct(
    ...
    """Resize the complete image directly without cropping or padding."""
    has_batch_dim = images.ndim == 4
    if not has_batch_dim:
        images = images[None]  # type: ignore
