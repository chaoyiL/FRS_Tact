...
def get_action_normalizer(
    ...
    elif D == 20 and bimanual_contiguous:
        normalizers = []
        normalizers.append(get_range_normalizer_from_stat(array_to_stats(actions[..., :3])))
        normalizers.append(get_identity_normalizer_from_stat(array_to_stats(actions[..., 3:9])))
        normalizers.append(get_range_normalizer_from_stat(array_to_stats(actions[..., 9:10])))
        normalizers.append(get_range_normalizer_from_stat(array_to_stats(actions[..., 10:13])))
        normalizers.append(get_identity_normalizer_from_stat(array_to_stats(actions[..., 13:19])))
        normalizers.append(get_range_normalizer_from_stat(array_to_stats(actions[..., 19:20])))
    elif D == 18 or D == 20:
        normalizers = []
        normalizers.append(get_range_normalizer_from_stat(array_to_stats(actions[...,:3])))
        # don't normalize rotation
