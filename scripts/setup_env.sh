...
UV_DEFAULT_INDEX_VALUE="${FRS_PYPI_INDEX_URL:-https://pypi.tuna.tsinghua.edu.cn/simple}"
UV_HTTP_TIMEOUT_VALUE="${FRS_UV_HTTP_TIMEOUT:-300}"
...
HF_ENDPOINT_VALUE="${FRS_HF_ENDPOINT:-https://hf-mirror.com}"
...
write_environment_file() {
    ...
    env_tmp="$(mktemp --tmpdir="${PROJECT_ROOT}" .env.frs.XXXXXX)"
    {
        ...
        printf 'export UV_HTTP_TIMEOUT=%q\n' "${UV_HTTP_TIMEOUT}"
...
main() {
    ...
    echo "Python 包镜像：${UV_DEFAULT_INDEX}"
