# Vendored from openpi (Apache-2.0), src/openpi/shared/array_typing.py,
# commit 15a9616a00943ada6c20a0f158e3adb39df2ccac (2026-06-16). Unmodified except this header.
# See ../pi05_frs_plan.md and README.md in this directory for why this is vendored instead of
# depending on the `openpi` package directly.
